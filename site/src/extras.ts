...
// The iframe fills the window 1:1 and the site renders responsively to it.
// (The frame is a flex child that grows with the window, so no fixed height
// and no scaling maths: both were the source of the earlier crop/sliver bugs.)
